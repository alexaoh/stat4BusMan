...
This means that we will have approximately `r round(DPMO, 1)` defective parts per million opportunities in the long run. Hence, this is a Six Sigma process. 
...
out/dim(Y)[1]*10^6
```
 and hence, from the Sigma Scale table, this is a 4 sigma process. **This is a contradiction, what is correct here?**
