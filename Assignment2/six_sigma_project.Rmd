...
2) Compare \% defective phones by different [material] supplier
...
```
The observed process does not perfectly match the optimal one, but is very close. The variance is still slithly bigger, the mean is in fact higher than it was defined by managers in the beginning.